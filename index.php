...
<body>
    ...
    <section class="home">
        ...
        <ul class="wrapper">
            <a href="https://www.facebook.com/HuyPham795"><li class="icon facebook">
           ...
           <a href="https://www.instagram.com/_qhuy.ne_/"><li class="icon instagram">
    ...
    <section class="container-1">
        ...
        <center><h2 style="font-size: 2em;font-weight: 400;margin:40px 40px 0 40px;">Why should you choose our website?</h2></center>
